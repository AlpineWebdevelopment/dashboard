      ...
      <>
        ...
        {sheets.length === 0 && folders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 rounded-2xl border border-dashed border-zinc-200/60 dark:border-white/[0.06]">
            <p className="text-sm text-zinc-500 mb-1 dark:text-zinc-200">No tables yet</p>
            <p className="text-[13px] text-zinc-500 dark:text-zinc-200">Hit "New Table" or drag tables here from the root</p>
          </div>
