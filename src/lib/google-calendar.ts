...
// encrypted rather than stored as plaintext rows. The helpers are shared with
// the social scheduler and live in lib/crypto; re-exported here so google-sync
// keeps importing them from where it always has.
