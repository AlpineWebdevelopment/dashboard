        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center py-20 sm:py-28 rounded-2xl border border-dashed border-zinc-200/60 dark:border-white/[0.06]">
            <div className="w-11 h-11 rounded-xl border border-zinc-200 dark:border-white/[0.08] panel bg-zinc-100/60 dark:bg-white/[0.03] flex items-center justify-center mb-4">
              <CalendarDays size={16} className="text-zinc-500 dark:text-zinc-200" />
            </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                  {folders.map((folder) => (
                    <Link
                      ...
                      className="flex items-center gap-2.5 px-4 py-3 rounded-xl border border-zinc-200 dark:border-white/[0.05] panel bg-zinc-50/50 dark:bg-white/[0.02] hover:bg-zinc-100 dark:hover:bg-white/[0.05] hover:border-zinc-300 dark:hover:border-white/[0.09] transition-all group"
                    >
                      <FolderOpen size={13} className="text-zinc-500 dark:text-zinc-200 group-hover:text-amber-400/70 shrink-0 transition-colors" />
                      <span className="text-sm font-medium text-zinc-500 dark:text-zinc-200 group-hover:text-zinc-800 dark:group-hover:text-white transition-colors truncate">
                        {folder.name}
                      </span>
                    </Link>
                  ))}
