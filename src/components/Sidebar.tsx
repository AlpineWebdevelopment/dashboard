...
import { LayoutDashboard, FileText, Settings, Table2, CheckSquare, Search, CalendarDays, Newspaper, Target, LogOut, ShoppingBag, PenTool, Menu, X, Bot, CalendarCheck } from 'lucide-react'
