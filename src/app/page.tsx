  ...
  return (
    <div className="min-h-screen px-8 py-10 max-w-4xl">
      ...
      <div className="grid grid-cols-3 gap-4 mb-10">
        ...
        />
        <StatCard label="Words Written" value={pages.reduce((acc, p) => acc + (p.content?.split(/\s+/).filter(Boolean).length ?? 0), 0)} />
      </div>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 rounded-xl bg-white/[0.02] border border-white/[0.06] border-dashed">
      ...
      <p className="text-sm text-zinc-500 mb-4">No pages yet. Start writing.</p>
      <Link
        href="/pages"
