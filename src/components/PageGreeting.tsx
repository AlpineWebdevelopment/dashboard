...
export default function PageGreeting() {
  ...
  return (
    <div className="flex items-center gap-4">
      <div className={`shrink-0 w-10 h-10 rounded-xl border border-zinc-200 dark:border-white/[0.08] panel bg-zinc-100/60 dark:bg-white/[0.04] flex items-center justify-center shadow-lg ${glowClass}`}>
      ...
      <div>
        ...
        <p className="text-sm text-zinc-500 dark:text-zinc-200 mt-0.5">{motivation}</p>
      </div>
    </div>
  )
}
